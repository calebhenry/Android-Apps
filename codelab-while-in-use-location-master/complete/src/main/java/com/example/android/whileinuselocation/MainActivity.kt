 ...
 */
class MainActivity : AppCompatActivity(), SharedPreferences.OnSharedPreferenceChangeListener, OnMapReadyCallback {
    ...
    // Holds the map view the user sees
    private lateinit var mapView: MapView

    // Holds the google map the map view displays
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        // Initialize the map view variable
    ...
    private inner class ForegroundOnlyBroadcastReceiver : BroadcastReceiver() {
        ...
        override fun onReceive(context: Context, intent: Intent) {
            ...
            if (location != null) {
                ...
                // Clear the previous polyline and marker
                googleMap.clear()

                // Draw the polyline and marker
