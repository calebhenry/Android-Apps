...
enum class LunchTrayScreen(@StringRes val title: Int) {
    ...
    Accomp(title = R.string.choose_accompaniment),
        ...
        NavHost(
            ...
            composable(route = LunchTrayScreen.Side.name) {
                SideDishMenuScreen(
                    ...
                    onCancelButtonClicked = { cancelOrderAndNavigateToStart(viewModel, navController) },
                    onNextButtonClicked = { navController.navigate(LunchTrayScreen.Accomp.name) },
            ...
            composable(route = LunchTrayScreen.Accomp.name) {
